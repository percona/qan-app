...
class PostgreSQLService extends __BaseService {
   ...
   * @return A successful response.
   */
  AddPostgreSQL(body: { address?: string, custom_labels?: { [key: string]: string }, environment?: string, node_id?: string, password?: string, pmm_agent_id?: string, port?: number, service_name?: string, username?: string }): __Observable<{ postgres_exporter?: { agent_id?: string, custom_labels?: { [key: string]: string }, disabled?: boolean, listen_port?: number, password?: string, pmm_agent_id?: string, service_id?: string, status?: 'AGENT_STATUS_INVALID' | 'STARTING' | 'RUNNING' | 'WAITING' | 'STOPPING' | 'DONE', username?: string }, service?: { address?: string, custom_labels?: { [key: string]: string }, environment?: string, node_id?: string, port?: number, service_id?: string, service_name?: string } }> {
